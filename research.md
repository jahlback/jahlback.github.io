...
with Alex Yeandle
<details><summary>Abstract</summary>
Climate change is making natural disasters more frequent and severe, but we know little about their electoral consequences beyond wealthy democracies. Amid weak state capacity and constrained political competition, we argue that natural disasters harm incumbents in areas lacking investment and where opposition groups can campaign freely. We test this argument in Malawi, where Cyclone Idai, one of the deadliest cyclones ever recorded, caused extreme mass floods just 2 months before the 2019 general elections. In a matched difference-in-differences setting, leveraging geocoded polling station returns, fine-grained measures of flooding, and geological data on flood risk, we show that ruling party vote share fell by around 7pp in affected communities. This is driven by areas with lower historic incumbent support, which, using survey and qualitative evidence, we show were a) less financially resilient to the shock, and b) more physically accessible for opposition campaigners. These findings advance the literature on climate change, political behaviour, and accountability in low-income states. 
</details>
